...
| 7 | Detail Done | [Crop](audit-crops/issue-07.png). Native toolbar uses semantic body but system caps visual growth; still fully visible/actionable. Raw partial Dynamic Type remains a documented platform presentation limitation. |
...
| 14 | Capture Cancel | [Crop](audit-crops/issue-14.png). Native toolbar label remains readable/actionable; system-capped partial Dynamic Type remains documented. |
